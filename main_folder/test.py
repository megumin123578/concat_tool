...
from module2 import auto_concat, find_first_vid, excel_to_sheet, get_file_name, insert_logo
...
def main():
    ...
    for ls in results:
        ...
        logo_path = r"F:\ouput\output_show_asmr\71 _ v125_ghep\V83_Thumb.jpg"
        final_output = output_path.replace(".mp4", "_logo.mp4")
        insert_logo(output_path, logo_path, final_output)
